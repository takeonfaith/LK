import{s as l,j as r,F as h}from"./vendor-0c76c893.js";import{T as c,M as j,f as x,bu as u,ar as g,W as b,u as m,ai as d,g as p}from"./index-8d41848f.js";import{B as f}from"./index-dc78f9a9.js";import{g as _}from"./get-short-string-60b0c4d4.js";const v=e=>!!new RegExp("^(https?:\\/\\/)?((([a-z\\d]([a-z\\d-]*[a-z\\d])*)\\.)+[a-z]{2,}|((\\d{1,3}\\.){3}\\d{1,3}))(\\:\\d+)?(\\/[-a-z\\d%_.~+]*)*(\\?[;&a-z\\d%_.~+=-]*)?(\\#[-a-z\\d_]*)?$","i").test(e),S=l.div`
    max-width: 400px;
