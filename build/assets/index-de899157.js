import{s as p,j as e,r as h,ac as f}from"./vendor-1714f5a3.js";import{$ as j,m as v,t as w,l as b,u as m,T as x,ai as S,g as C,z as u,ar as y,H as A,v as k,W as z,r as D,E as T}from"./index-a5eecfde.js";import{B as I}from"./index-06cfa6e7.js";import{g as $}from"./get-short-string-60b0c4d4.js";const E=async()=>(await j.get(`?getAlerts&token=${v()}`)).data,M=t=>t.reduce((s,n)=>{const r=new Date(n.date).getFullYear();return s[r]?s[r].push(n):s[r]=[n],s},{}),g=w({api:{get:E},prepareData:M}),N=p.div`
    width: 100%;
    padding: 16px;
