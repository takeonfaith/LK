import{y as l,s as h,a6 as d,aI as g,j as e}from"./vendor-0c76c893.js";import{x as m,W as x,r as j,al as P}from"./index-8d41848f.js";import{g as y,a as v}from"./student-api-82beabef.js";import{c as M,L as k}from"./index-d4ddb0fe.js";import{B as F}from"./index-dc78f9a9.js";import"./index-697735f0.js";const L=l(async n=>{const{search:o="",page:i,limit:r,filter:a}=n,{data:s}=await y(o,(a==null?void 0:a.id.toString())??"",i,r);return{results:s.items}}),p=M({getFx:L,limit:50}),S=h.div`
    width: 100%;
    display: flex;
