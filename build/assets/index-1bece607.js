import{s as g,r as a,j as t,F as m,R as f,aH as D}from"./vendor-1714f5a3.js";import{l as i,d as n,T as x,D as v,M as A,L as F,f as y,g as L,F as T,h as w,P as S,i as P}from"./index-a5eecfde.js";const R=e=>{if(!e[0].length&&e[1].length)return`За весь период до ${i(e[1])} включительно`;if(e[0].length&&!e[1].length)return`За весь период начиная с ${i(e[0])} включительно`;if(!e[0].length&&!e[1].length)return"За все время";if(e[0].length&&e[1].length)return`За период с ${i(e[0])} по ${i(e[1])}`},C=g.div`
    .content {
        display: flex;
