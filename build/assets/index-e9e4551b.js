import{r as c,s as d,j as e,aH as m,c as f}from"./vendor-0c76c893.js";import{av as g,a as j,x as b,L as h,B as y,ar as w,M as k,S as v,l as M,ai as S}from"./index-8d41848f.js";function C({isDone:s,submit:t,setData:o}){const[l,i]=c.useState(!1),[u,a]=c.useState(!1),[x,n]=c.useState(s??!1),p=async()=>{try{i(!0),await t(),i(!1),a(!0),n(!0)}catch{i(!1),j.evokePopUpMessage({message:"Не удалось подписать",type:"failure"})}};return c.useEffect(()=>{o&&g().then(r=>o(r.data[0]))},[]),{done:x,open,loading:l,completed:u,setCompleted:a,handleSubmit:p}}const D=d.div`
    display: flex;
