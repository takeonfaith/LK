import{s as d,L as S,aQ as u,j as e,aS as K,r as m,a3 as L,f as I,q as $,n as W,aT as k,aU as E,M as O,x as _,aH as A,aI as F}from"./vendor-292fea82.js";import{ar as v,f as z,as as x,at as J,au as j,av as T,aw as h,l as p,ax as c,a as N,ay as H,T as f,az as R,aA as U,ad as Q,Q as M,W as q,g as G,a9 as V}from"./index-ddc703de.js";import{I as B}from"./index.esm-5250088b.js";const X=(s,t)=>t.filter(a=>v(a.name).includes(v(s))),Y=d(S)`
...
`,ue=({messages:s})=>e.jsxs(ge,{children:[Object.values(b(s)).length===0&&e.jsx(C,{message:"Нет сообщений"}),Object.values(b(s)).map((t,a)=>e.jsxs(e.Fragment,{children:[e.jsx(xe,{date:t.date}),e.jsxs("div",{className:"messages-section",children:[e.jsx("div",{className:"message-avatar",children:e.jsx(j,{name:t.messages[0].sender,avatar:t.avatar,width:"32px",height:"32px",marginRight:"0"})}),e.jsx("div",{className:"messages",children:t.messages.map((n,i)=>e.jsx(ae,{name:n.sender,message:n,isLast:i===t.messages.length-1},i))})]},a)]}))]}),fe=d.div`
...
`,je=()=>{var r;const[s,t]=m.useState(null),[a,n]=m.useState(!0),i=(r=u(x))==null?void 0:r.params,o=[{avatar:void 0,name:"Стелла",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"1",amountOfUnreadMessages:10},{avatar:"https://upload.wikimedia.org/wikipedia/ru/thumb/d/df/Andrew_Garfield_as_Spider-Man.jpg/280px-Andrew_Garfield_as_Spider-Man.jpg",name:"Питер Паркер",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"2",amountOfUnreadMessages:0},{avatar:void 0,name:"Рафаэль",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"3",amountOfUnreadMessages:0},{avatar:void 0,name:"Леонардо",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"4",amountOfUnreadMessages:0},{avatar:void 0,name:"Бред Питт",lastMessage:{message:"Привет. Как дела?",sentTime:"12:23"},chatId:"5",amountOfUnreadMessages:0}];return e.jsxs(Te,{isOpen:a,chatId:i==null?void 0:i.chatId,children:[e.jsxs("div",{className:"chat-list-top-section",children:[e.jsx(f,{size:3,align:"left",children:"Чаты"}),e.jsx(c,{onClick:()=>n(l=>!l),icon:a?e.jsx(O,{}):e.jsx(_,{})})]}),e.jsx(M,{whereToSearch:o,searchEngine:X,setResult:t,placeholder:"Поиск чатов"}),e.jsx(G,{margin:"10px auto"}),e.jsx(re,{chats:s??o,isOpen:a})]})},ve=d.div`
    display: flex;
    align-items: center;
    background: var(--schedule);
    padding: 5px 10px;
...
`,ke=()=>{var n;const s=(n=u(x))==null?void 0:n.params,[t,a]=m.useState(!0);return m.useEffect(()=>{a(!0),setTimeout(()=>{a(!1)},1e3)},[s.chatId]),e.jsxs(be,{children:[e.jsx(de,{name:"Леонаро ДиК априо",loading:t}),e.jsx(me,{loading:t}),e.jsx(we,{})]})},ze=d.div`
    ...
    width: 100%;
    height: 100%;
`,De=()=>{var t;const s=(t=u(x))==null?void 0:t.params;return e.jsxs(ze,{children:[e.jsx(je,{}),!(s!=null&&s.chatId)&&e.jsx(C,{}),e.jsx(A,{children:e.jsx(F,{path:x,children:e.jsx(ke,{})})})]})};export{De as default};
