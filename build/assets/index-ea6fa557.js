import{y as l,s as h,a6 as d,aI as g,j as e}from"./vendor-0c76c893.js";import{x as m,W as x,r as j,al as P}from"./index-1840b39c.js";import{g as y,a as v}from"./student-api-ab728b47.js";import{c as M,L as k}from"./index-11db7722.js";import{B as F}from"./index-012ca6bf.js";import"./index-5e6bbadd.js";const L=l(async n=>{const{search:o="",page:i,limit:r,filter:a}=n,{data:s}=await y(o,(a==null?void 0:a.id.toString())??"",i,r);return{results:s.items}}),p=M({getFx:L,limit:50}),S=h.div`
    width: 100%;
    display: flex;
