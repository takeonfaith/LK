...
`,fe=()=>{var y;const{data:e,loading:i,error:s}=m.selectors.useData(),{data:{user:r}}=N.useUser(),o=l.useMemo(()=>R((r==null?void 0:r.course)??0),[r]),[n,F]=l.useState({id:g(new Date().toString(),(r==null?void 0:r.course)??1),title:g(new Date().toString(),(r==null?void 0:r.course)??1).toString()+" семестр"}),[x,E]=l.useState(null);return l.useEffect(()=>{m.effects.getFx({semestr:`${(n==null?void 0:n.id)!==-1?n==null?void 0:n.id:""}`})},[n]),t.jsx(W,{loading:i,load:()=>m.effects.getFx({semestr:`${(n==null?void 0:n.id)!==-1?n==null?void 0:n.id:""}`}),error:s,data:e,children:t.jsxs(pe,{children:[!!(r!=null&&r.id)&&t.jsx(B,{items:o,selected:n,setSelected:F}),((y=e==null?void 0:e.exam)==null?void 0:y.length)===0&&(e==null?void 0:e.test.length)===0&&!i?t.jsx(M,{text:"Данных за этот семестр нет, попробуйте другой!"}):t.jsxs(t.Fragment,{children:[t.jsx(X,{}),t.jsx("div",{className:"search-and-filter",children:t.jsx(O,{whereToSearch:[...(e==null?void 0:e.exam)??[],...(e==null?void 0:e.test)??[]],searchEngine:H,setResult:E,placeholder:"Поиск предметов"})}),t.jsx(C,{header:"Экзамены",items:(x==null?void 0:x.exam)??(e==null?void 0:e.exam),loading:i}),t.jsx(C,{header:"Зачеты",items:(x==null?void 0:x.test)??(e==null?void 0:e.test),type:"test",loading:i})]})]})})};export{fe as default};
