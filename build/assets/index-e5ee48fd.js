import{y as h,s as u,a6 as g,j as o}from"./vendor-0c76c893.js";import{$ as p,m as d,x,W as m,r as $}from"./index-a7bcef13.js";import{c as j,L as v}from"./index-5cc683df.js";import{B as P}from"./index-80b0a22e.js";import"./index-80d7ddc5.js";const y=(t,a,n,i)=>p.get(`?getStaff&search=${t}&division=${a}&page=${n}&perpage=${i}&token=${d()}`),f=t=>p.get(`?getDivs=${t}&page=1&token=${d()}`),k=h(async t=>{const{search:a,page:n,limit:i,filter:e}=t,c=(e==null?void 0:e.title)==="Все"?"":(e==null?void 0:e.title)??"",{data:r}=await y(a??"",c,n,i);return{results:r.items}}),l=j({getFx:k,limit:50}),F=u.div`
    width: 100%;
    display: flex;
