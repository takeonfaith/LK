import{d as r,h as x,e as p,a6 as d,s as i,j as e,r as F,bc as D,ab as S}from"./vendor-1714f5a3.js";import{$ as v,b7 as b,S as m,x as $,ar as T,T as k,ao as L,a0 as u,M,ai as R,aW as _,f as P,aX as z}from"./index-a5eecfde.js";const I=async a=>{const t=new FormData;return t.set("avatar",a[0]),await v.post("?changeAvatar=1",t,{headers:{"Content-Type":"multipart/form-data"}})},O=async a=>{const t=new FormData;return t.set("email",a),await v.post("?changeEmail=1",t)},h={loading:!1,completed:!1,error:null},W={data:[],...h},B={data:"",...h},U={data:"",...h},w=r(),j=r(),n=x(async a=>{try{await I(a)}catch{throw new Error("Не удалось загрузить фотографию")}}),V=p(W).on(w,(a,t)=>({...a,data:t})).on(n,a=>({...a,error:null,loading:!0,completed:!1})).on(n.doneData,a=>({...a,error:null,loading:!1,completed:!0})).on(n.fail,(a,{error:t})=>({...a,error:t.message,loading:!1,completed:!1})).on(j,(a,t)=>({...a,completed:t})),A=r(),s=x(async a=>{try{await O(a)}catch{throw new Error("Не удалось изменить email")}}),N=p(U).on(A,(a,t)=>({...a,data:t})).on(s,a=>({...a,loading:!0})).on(s.doneData,a=>({...a,loading:!1,completed:!0,error:null})).on(s.failData,(a,t)=>({...a,loading:!1,completed:!1,error:t.message})),X=r(),q=p(B).on(X,(a,t)=>({...a,data:t})),G=()=>({avatar:d(V),adPass:d(q),email:d(N)}),E={useData:G},o={avatar:{changeAvatar:w,changeCompleted:j},email:{changeEmail:A}},H={avatar:{postAvatarFx:n},email:{postNewEmail:s}},J=i.div`
    min-width: 500px;
    display: flex;
    flex-direction: column;
    row-gap: 8px;
`,K=()=>{const{avatar:{data:a,loading:t,completed:l}}=E.useData(),c=()=>{H.avatar.postAvatarFx(a)};return e.jsxs(J,{children:[e.jsx(b,{maxFileSizeInBytes:0,files:a,setFiles:o.avatar.changeAvatar,isActive:!0,maxFiles:1,formats:["image/jpeg","image/jpg"]}),e.jsx(m,{text:"Изменить фотографию",isLoading:t,completed:l,action:c,isActive:a.length===1,popUpFailureMessage:"Фотография не загружена",setCompleted:o.avatar.changeCompleted})]})},Q=i.div`
    display: flex;
    flex-direction: column;
