...
`,pn=({children:e,load:t,error:i,data:s,deps:a=[],noDataCheck:r=!1,loadEveryVisit:o=!1})=>(c.useEffect(()=>{(!s||o)&&t()},a),n.jsxs(od,{loading:!!i||!s,children:[n.jsx("span",{className:"loading",children:i?n.jsx("div",{className:"reload",children:n.jsx(oe,{text:i,image:r&&ad,children:!r&&n.jsx(j,{onClick:()=>t(),text:"Загрузить снова",icon:n.jsx(wi,{})})})}):n.jsx($e,{})}),n.jsx("div",{className:"content",children:e})]})),ld=x.a`
    display: flex;
    align-items: center;
...
`,Oe=(e,t)=>{if(!e.length)return"";const i=t??!0,s=e.replace(/\s/g,"").replace(/\$/g,"s").replace(/-/g,"").toLowerCase();return i?s.replace(/[,'._/]/g,""):s},Kn=e=>{const t={a:"ф",b:"и",c:"с",d:"в",e:"у",f:"а",g:"п",h:"р",i:"ш",j:"о",k:"л",l:"д",m:"ь",n:"т",o:"щ",p:"з",q:"й",r:"к",s:"ы",t:"е",u:"г",v:"м",w:"ц",x:"ч",y:"н",z:"я","[":"х","{":"х","]":"ъ","}":"ъ","'":"э",";":"ж",",":"б",".":"ю"};let i="";for(let s=0;s<e.length;s++){const a=Oe(e.charAt(s),!1),r=t[a]?s===0?t[a].toUpperCase():t[a]:a;i+=r}return i},vd=e=>/[A-Za-z]/.test(e),yd=x.div`
    display: flex;
    flex-direction: column;
    row-gap: 8px;
    width: ${({width:e})=>e??"100%"};
...
`,gp=({stagesConfig:e})=>{const[t,i]=c.useState(0),[s,a]=c.useState({});c.useEffect(()=>{r(0)},[]);const r=o=>{a(l=>({...l,[t]:Ie(e[t][0].dataForm)})),i(o)};return n.jsxs(n.Fragment,{children:[n.jsx(up,{children:e.map((o,l)=>n.jsxs(hp,{lastElement:l===e.length-1,children:[n.jsx(pp,{current:l===t,onClick:()=>r(l),reached:s[l],children:l+1}),l!==e.length-1&&n.jsx(fd,{direction:"horizontal",reached:s[l],filled:100,distance:40})]},l))}),n.jsx(n.Fragment,{children:e[t].map((o,l)=>c.createElement(dp,{...o.dataForm,setData:o.setDataForm,key:l}))})]})},fp=()=>({title:"Дополнительно",data:[{title:"Комментарий",type:"textarea",fieldName:"comment",value:"",editable:!0}]}),xp=()=>({title:"Период предоставления льготы",hint:"Период предоставления льготы по плате за пользование жилым помещением соответствует дате подачи заявки и дате окончания действия документа",data:[{title:"Начало периода соответствия льготной категории",type:"date",value:"",fieldName:"beginning_of_benefit_period",editable:!0,required:!0},{title:"Окончание периода соответствия льготной категории",type:"date",value:"",fieldName:"end_of_benefit_period",editable:!0,required:!0},{title:"Отсутствует срок действия документа (бессрочный)",type:"checkbox",value:"",fieldName:"is_indefinite",editable:!0,required:!1}],documents:{files:[],required:!0,checkboxCondition:"reverse",fieldName:"invalidFiles",maxFiles:1,allowedTypes:["application/pdf"]}}),mp=()=>({title:"Адрес регистрации",data:[],hint:"Необходимо приложить скан-копию 2-3 страниц паспорта, а также страниц с регистрацией. Для иностранных студентов обязательно приложить перевод паспорта.",documents:{files:[],required:!0,fieldName:"registrationFiles",maxFiles:1,allowedTypes:["application/pdf"]}}),bp=e=>e.data.reduce((t,i)=>{var s;if(!i.value)return t;if(i.type==="checkbox-docs"){const a=(s=i.items)==null?void 0:s.reduce((r,o)=>{for(let l=0;l<o.files.length;l++)r[(o==null?void 0:o.fieldName)+`[${l}]`]=o.files[l];return r},{});t=Object.assign({},t,a)}else if(i.type==="select")t[i.fieldName]=i.isSpecificSelect?i.value.id:i.value.title||null;else{const a=!i.value||typeof i.value!="object";t[i.fieldName]=a?i==null?void 0:i.value:i.value.title}return t},{}),vp=async(e,t,i,s,a=!1)=>{i(!0);const r=t.map(p=>{if(a)return bp(p);if(Array.isArray(p.data[0])){const u=p.data.map(b=>Object.assign({},...b==null?void 0:b.map(h=>Qn(h)))),m={};return m[e]=JSON.stringify(u),m}else return p.data.map(u=>Qn(u))}).flat(),o=t.map(p=>{var m,b;const u={};if((m=p.documents)!=null&&m.fieldName)for(let h=0;h<p.documents.files.length;h++)u[((b=p.documents)==null?void 0:b.fieldName)+`[${h}]`]=p.documents.files[h];return u}),l=t.map(p=>{var m,b;const u={};return(m=p.optionalCheckbox)!=null&&m.fieldName&&(u[(b=p.optionalCheckbox)==null?void 0:b.fieldName]=p.optionalCheckbox.value),u}),d=Object.assign({},...r,...o,...l);try{await Se.postApplicationFx({formId:e,args:d}),i(!1),s(!0)}catch(p){i(!1),z.evokePopUpMessage({message:`Не удалось отправить форму. Ошибка: ${p}`,type:"failure",time:3e4})}},Qn=e=>{var i;const t={};return t[(e==null?void 0:e.fieldName)??""]=yp(e),e.type==="multiselect"&&(t[(e==null?void 0:e.fieldName)??""]=JSON.stringify((e==null?void 0:e.value).map(s=>s.title))),e.type==="checkbox-docs"?(i=e.items)==null?void 0:i.reduce((s,a)=>{for(let r=0;r<a.files.length;r++)s[(a==null?void 0:a.fieldName)+`[${r}]`]=a.files[r];return s},{}):t},yp=e=>!e.value||typeof e.value!="object"?e==null?void 0:e.value:e.value.title,wp=x.div`
    ...
    padding: 10px;
    color: var(--text);
`;var Cs=(e=>(e.USG_GETHOSTEL_O="usg_gethostel_o",e.USG_GETHOSTEL_OOZ="usg_gethostel_ooz",e.USG_GETHOSTEL_Z="usg_gethostel_z",e.USG_GETHOSTEL_AO="usg_gethostel_ao",e.USG_GETHOSTEL_BENEFIT="usg_gethostel_benefit",e.USG_GETHOSTEL_FAMILY="usg_gethostel_family",e.USG_CONTR_TERMINATION="usg_contr_termination",e.USG_RELOCATION_INNER="usg_relocation_inner",e.USG_RELOCATION="usg_relocation",e.OBUCH="obuch",e.STATUS_SOBES="status_sobes",e.SPRVIZOV="sprvizov",e.PERS_DATA="pers_data",e.PROPUSK_RESTORE="propusk_restore",e.PASSPORT_DATA="passport_data",e.DIPL_OTL="dipl_otl",e.STATUS_REGULAR="status_regular",e.OKID_LICAKKRED="okid_licakkred",e.MILDOCS="mildocs",e.VOEN_UCH="voen_uch",e.PR_DONATE="pr_donate",e.PR_MATPOM="pr_matpom",e.PR_SOCSTIP="pr_socstip",e.HIGH_SCHOLARSHIP="high_scholarship",e.DOP_SOGL="dop_sogl",e.SEND_PAYMENT_EDU="send_payment_edu",e.FREE_REQUEST="free_request",e.CRS_VACATIONS="crs_vacations",e.CRS_ACADEMVAC="crs_academvac",e.CRS_EXPULSION="crs_expulsion",e.CRS_ATTESTAT="crs_attestat",e.MEDICAL_CERT="postRequestMedicalCertificate",e.WORK_TRANSFER="",e.EXTRA_HOLIDAY_COLL="",e.HOLIDAY_PLANNING="",e.HOLIDAY_WORK="",e.DISMISSAL="",e.HOLIDAY_POSTPONED="",e.PART_TIME_EMPLOYMENT="",e))(Cs||{}),_p=(e=>(e.CONTACT_INFO_ACTUALIZATION="contact-info-actualization",e.DATA_VERIFICATION_ROUTE="data-verification",e.ISSUANCE_OF_LICENSES="issuance-of-licenses",e.GETTING_COMPUTER_EQUIPMENT="getting-computer-equipment",e.CONNECTING_COMPUTER="connecting-computer",e.PRINTER_MAINTENANCE="printer-maintenance",e.QUESTION_SED="question-sed",e.QUESTION_PERSONAL_ACCOUNT="question-personal-account",e.OTHER_IT_SERVICES="other-it-services",e.CERTIFICATE_FROM_PLACE_OF_WORK="certificate-from-the-place-of-work",e.VISA_CERTIFICATE="visa-certificate",e.CERTIFICATE_OF_WORK_EXPERIENCE="certificate-of-work-experience",e.NUMBER_OF_UNUSED_VACATION_DAYS="number-of-unused-vacation-days",e.COPY_OF_EMPLOYMENT_RECORD="copy-of-the-employment-record",e.COPIES_OF_DOCUMENTS_FROM_PERSONAL_FILE="copies-of-documents-from-the-personal-file",e.WORK_ON_TERMS_OF_EXTERNAL_CONCURRENCY="work-on-the-terms-of-external-concurrency",e.CERTIFICATE_TIME_PARENTAL_LEAVE="certificate-time-parental-leave",e.COURIER="courier",e.PERSONA_INCOME_TAX_REFERENCE="persona-income-tax-reference",e.PAYMENT_OF_CHILD_BIRTH_ALLOWANCE="payment-of-child-birth-allowance",e.PAYMENT_FOR_CHILD_CARE="payment-for-child-care",e))(_p||{});const jp=[{id:0,title:"имею постоянную регистрацию за пределами А-107 или не имею постоянную регистрацию"},{id:1,title:"имею постоянную регистрацию в пределах А-107"}],Tp=e=>{const{surname:t,name:i,patronymic:s,group:a,email:r,phone:o}=e;return{title:"Контактная информация",data:[{title:"ФИО",fieldName:"fio",value:t+" "+i+" "+s,editable:!1},{title:"Учебная группа",fieldName:"group",type:"tel",value:a,editable:!1},{title:"Электронная почта",fieldName:"email",type:"email",value:r,editable:!0,required:!0},{title:"Телефон",fieldName:"phone",type:"tel",value:o,editable:!0,required:!0},{title:"Причина предоставления (в связи с)",type:"select",width:"100%",value:null,fieldName:"reason",placeholder:"укажите причину",editable:!0,required:!0,items:jp},{title:"Приоритетное общежитие",fieldName:"priority_hostel",value:"",type:"select",width:"100%",editable:!0,required:!0,items:[{id:0,title:"1 общежитие"},{id:1,title:"2 общежитие"},{id:2,title:"3 общежитие"},{id:3,title:"4 общежитие"},{id:4,title:"5 общежитие"},{id:5,title:"6 общежитие"},{id:6,title:"7 общежитие"},{id:7,title:"8 общежитие"},{id:8,title:"9 общежитие"},{id:9,title:"10 общежитие"}]}]}},Ep=()=>{var q;const[e,t]=c.useState(null),[i,s]=c.useState(vt.kvdCert),[a,r]=c.useState(vt.fluorographyCert),[o,l]=c.useState(vt.vichRwCert),[d,p]=c.useState(vt.graftCert),{data:{dataUserApplication:u}}=He.useApplications(),{data:{user:m}}=Q.useUser(),[b,h]=c.useState(!1),[g,f]=c.useState(!1),[v,S]=c.useState(null),[w,E]=c.useState(null),[$,D]=c.useState(null),H=b??!1;if((m==null?void 0:m.educationForm)!=="Недоступен")return n.jsx(oe,{text:"Сервис временно недоступен в связи с отсутствием свободных мест"});const B=!!e&&!!w&&!!v&&!!$;if(c.useEffect(()=>{u&&(t(Tp(u)),S(xp()),E(mp()),D(fp()))},[u]),!B)return null;const ee=[[{dataForm:e,setDataForm:t}],[{dataForm:w,setDataForm:E}],[{dataForm:i,setDataForm:s}],[{dataForm:a,setDataForm:r}],[{dataForm:o,setDataForm:l}],[{dataForm:d,setDataForm:p}]];return n.jsx(wp,{isDone:H,children:n.jsxs(hn,{children:[n.jsx(U,{size:4,align:"left",children:"Предоставление права проживания (очно-заочная форма)"}),n.jsx(gp,{stagesConfig:ee}),n.jsx(Es,{text:"Отправить",action:()=>vp(Cs.USG_GETHOSTEL_OOZ,[e,w,v,$,i,a,o,d],f,h),isLoading:g,completed:b,setCompleted:h,repeatable:!1,buttonSuccessText:"Отправлено",isDone:H,isActive:(((q=e.optionalCheckbox)==null?void 0:q.value)??!0)&&Ie(e)&&Ie(a)&&Ie(o)&&Ie(d)&&Ie(i),popUpFailureMessage:"Для отправки формы необходимо, чтобы все поля были заполнены",popUpSuccessMessage:"Данные формы успешно отправлены"})]})})},ce=({oldVersionUrl:e,errorText:t="Страница еще находится в разработке. Если вам она нужна, вернитесь к старому дизайну",buttonText:i="Перейти к старому дизайну",forceForward:s=!1})=>(c.useEffect(()=>{s&&(window.location.href=`/old/?p=${e==null?void 0:e.slice(1,e.length)}`)},[]),n.jsx(oe,{text:t,children:n.jsx(un,{text:i,onClick:()=>{localStorage.setItem("useOldVersion","true")},background:"var(--purple)",width:"300px",href:`${de}/?p=${e==null?void 0:e.slice(1,e.length)}`})})),kp="modulepreload",Sp=function(e){return"/"+e},ei={},y=function(t,i,s){if(!i||i.length===0)return t();const a=document.getElementsByTagName("link");return Promise.all(i.map(r=>{if(r=Sp(r),r in ei)return;ei[r]=!0;const o=r.endsWith(".css"),l=o?'[rel="stylesheet"]':"";if(!!s)for(let u=a.length-1;u>=0;u--){const m=a[u];if(m.href===r&&(!o||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${r}"]${l}`))return;const p=document.createElement("link");if(p.rel=o?"stylesheet":kp,o||(p.as="script",p.crossOrigin=""),p.href=r,document.head.appendChild(p),o)return new Promise((u,m)=>{p.addEventListener("load",u),p.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${r}`)))})})).then(()=>t())},Op=c.lazy(()=>y(()=>import("./index-afaca04e.js"),["assets/index-afaca04e.js","assets/vendor-0c76c893.js"])),Pp=c.lazy(()=>y(()=>import("./index-3ec9d672.js"),["assets/index-3ec9d672.js","assets/vendor-0c76c893.js","assets/index-5c0d4f40.js"])),$p=c.lazy(()=>y(()=>import("./index-e6d185af.js"),["assets/index-e6d185af.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js"])),Ap=c.lazy(()=>y(()=>import("./index-ac51791f.js"),["assets/index-ac51791f.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-0e261f96.js"),["assets/index-0e261f96.js","assets/vendor-0c76c893.js"]));const Cp=c.lazy(()=>y(()=>import("./index-1aa3797d.js"),["assets/index-1aa3797d.js","assets/vendor-0c76c893.js","assets/get-method-obtaining-fields-a27a904a.js","assets/find-current-in-select-ba4611d5.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),Rp=c.lazy(()=>y(()=>import("./index-b4c46736.js"),["assets/index-b4c46736.js","assets/vendor-0c76c893.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),Ip=c.lazy(()=>y(()=>import("./index-4843070b.js"),["assets/index-4843070b.js","assets/vendor-0c76c893.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),Np=c.lazy(()=>y(()=>import("./index-554a3ab4.js"),["assets/index-554a3ab4.js","assets/vendor-0c76c893.js"])),Lp=c.lazy(()=>y(()=>import("./index-2686221d.js"),["assets/index-2686221d.js","assets/vendor-0c76c893.js"])),Dp=c.lazy(()=>y(()=>import("./index-2d312242.js"),["assets/index-2d312242.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js","assets/get-short-string-60b0c4d4.js"])),zp=c.lazy(()=>y(()=>import("./index-dbd24120.js"),["assets/index-dbd24120.js","assets/vendor-0c76c893.js"])),Mp=c.lazy(()=>y(()=>import("./index-7e2a24a5.js"),["assets/index-7e2a24a5.js","assets/vendor-0c76c893.js"])),Fp=c.lazy(()=>y(()=>import("./index-c0873abf.js"),["assets/index-c0873abf.js","assets/vendor-0c76c893.js"])),Up=c.lazy(()=>y(()=>import("./index-6afb3245.js"),["assets/index-6afb3245.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-4c6876ab.js"),["assets/index-4c6876ab.js","assets/vendor-0c76c893.js"]));const Bp=c.lazy(()=>y(()=>import("./index-e3b5521d.js"),["assets/index-e3b5521d.js","assets/vendor-0c76c893.js"])),Hp=c.lazy(()=>y(()=>import("./index-aff3678c.js"),["assets/index-aff3678c.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-d8f5ffdf.js"),["assets/index-d8f5ffdf.js","assets/vendor-0c76c893.js"]));const Wp=c.lazy(()=>y(()=>import("./index-9c6ccaaa.js"),["assets/index-9c6ccaaa.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-56b64e86.js"),["assets/index-56b64e86.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-f68959c6.js"),["assets/index-f68959c6.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-393fb256.js"),["assets/index-393fb256.js","assets/vendor-0c76c893.js"]));const Vp=c.lazy(()=>y(()=>import("./index-a0389f88.js"),["assets/index-a0389f88.js","assets/vendor-0c76c893.js"])),Gp=c.lazy(()=>y(()=>import("./index-dd905d33.js"),["assets/index-dd905d33.js","assets/vendor-0c76c893.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),qp=c.lazy(()=>y(()=>import("./index-3fb11bb3.js"),["assets/index-3fb11bb3.js","assets/vendor-0c76c893.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-student-subdivisions-5a2f2c8d.js","assets/get-divisions-96cfa1b1.js","assets/get-method-obstaing-c0726de9.js"])),Yp=c.lazy(()=>y(()=>import("./index-1830a419.js"),["assets/index-1830a419.js","assets/vendor-0c76c893.js"])),Kp=c.lazy(()=>y(()=>import("./index-04c2b9d0.js"),["assets/index-04c2b9d0.js","assets/vendor-0c76c893.js"])),Jp=c.lazy(()=>y(()=>import("./index-ee7e0944.js"),["assets/index-ee7e0944.js","assets/vendor-0c76c893.js"])),Xp=c.lazy(()=>y(()=>import("./index-5e135b8a.js"),["assets/index-5e135b8a.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-90e39797.js"),["assets/index-90e39797.js","assets/vendor-0c76c893.js"]));const Zp=c.lazy(()=>y(()=>import("./index-eff2391d.js"),["assets/index-eff2391d.js","assets/vendor-0c76c893.js"])),Qp=c.lazy(()=>y(()=>import("./index-16ab6ce7.js"),["assets/index-16ab6ce7.js","assets/vendor-0c76c893.js"])),eu=c.lazy(()=>y(()=>import("./index-041bb7c7.js"),["assets/index-041bb7c7.js","assets/vendor-0c76c893.js","assets/get-divisions-96cfa1b1.js"]));c.lazy(()=>y(()=>import("./index-7a5a613c.js"),["assets/index-7a5a613c.js","assets/vendor-0c76c893.js","assets/get-default-subdivision-c8e0589a.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js"]));c.lazy(()=>y(()=>import("./index-fe3d9247.js"),["assets/index-fe3d9247.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));const tu=c.lazy(()=>y(()=>import("./index-540b36e7.js"),["assets/index-540b36e7.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js"])),nu=c.lazy(()=>y(()=>import("./index-8a691644.js"),["assets/index-8a691644.js","assets/vendor-0c76c893.js","assets/find-current-in-select-ba4611d5.js"])),iu=c.lazy(()=>y(()=>import("./index-5ec45e2f.js"),["assets/index-5ec45e2f.js","assets/vendor-0c76c893.js"])),su=c.lazy(()=>y(()=>import("./index-e618c670.js"),["assets/index-e618c670.js","assets/vendor-0c76c893.js","assets/index-824b9df3.js","assets/index-012ca6bf.js"]));c.lazy(()=>y(()=>import("./index-e222b39e.js"),["assets/index-e222b39e.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-e7d809a0.js"),["assets/index-e7d809a0.js","assets/vendor-0c76c893.js","assets/get-default-subdivision-c8e0589a.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js"]));c.lazy(()=>y(()=>import("./index-96a9dbc1.js"),["assets/index-96a9dbc1.js","assets/vendor-0c76c893.js","assets/get-default-subdivision-c8e0589a.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));c.lazy(()=>y(()=>import("./index-fbe85f2e.js"),["assets/index-fbe85f2e.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));c.lazy(()=>y(()=>import("./index-ef519bd9.js"),["assets/index-ef519bd9.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js"]));c.lazy(()=>y(()=>import("./index-6044d3ff.js"),["assets/index-6044d3ff.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));c.lazy(()=>y(()=>import("./index-9014efe2.js"),["assets/index-9014efe2.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js"]));c.lazy(()=>y(()=>import("./index-1e280064.js"),["assets/index-1e280064.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js"]));c.lazy(()=>y(()=>import("./index-bd94585f.js"),["assets/index-bd94585f.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));c.lazy(()=>y(()=>import("./index-b9febec0.js"),["assets/index-b9febec0.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-c8e0589a.js"]));c.lazy(()=>y(()=>import("./index-72d76d4a.js"),["assets/index-72d76d4a.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js"]));c.lazy(()=>y(()=>import("./index-a1568af4.js"),["assets/index-a1568af4.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));c.lazy(()=>y(()=>import("./index-4f7ab593.js"),["assets/index-4f7ab593.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));c.lazy(()=>y(()=>import("./index-a1c0f354.js"),["assets/index-a1c0f354.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));c.lazy(()=>y(()=>import("./index-bd3f3f2a.js"),["assets/index-bd3f3f2a.js","assets/vendor-0c76c893.js","assets/get-default-subdivision-c8e0589a.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js"]));c.lazy(()=>y(()=>import("./index-9b077865.js"),["assets/index-9b077865.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js"]));c.lazy(()=>y(()=>import("./index-b35820ab.js"),["assets/index-b35820ab.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js"]));c.lazy(()=>y(()=>import("./index-863918cd.js"),["assets/index-863918cd.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-default-subdivision-c8e0589a.js"]));c.lazy(()=>y(()=>import("./index-333e7e9b.js"),["assets/index-333e7e9b.js","assets/vendor-0c76c893.js","assets/index-b5a82437.js","assets/get-method-obstaing-c0726de9.js","assets/get-basic-fields-application-teacher-b73a9173.js","assets/get-default-subdivision-c8e0589a.js","assets/get-method-obtaining-fields-a27a904a.js","assets/get-teacher-subdivisions-500dfe3f.js"]));const au=c.lazy(()=>y(()=>import("./index-ed72f7c5.js"),["assets/index-ed72f7c5.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js","assets/get-short-string-60b0c4d4.js","assets/get-correct-word-form-c0a854e8.js"]));c.lazy(()=>y(()=>import("./index-48a216eb.js"),["assets/index-48a216eb.js","assets/vendor-0c76c893.js","assets/index-11db7722.js","assets/index-5e6bbadd.js","assets/index-012ca6bf.js"]));const fn=c.lazy(()=>y(()=>import("./index-d6ddf505.js"),["assets/index-d6ddf505.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js","assets/teacher-data-6050d60a.js"]));c.lazy(()=>y(()=>import("./index-b83e2ec3.js"),["assets/index-b83e2ec3.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-492f8349.js"),["assets/index-492f8349.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-54201646.js"),["assets/index-54201646.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-a34d4bd5.js"),["assets/index-a34d4bd5.js","assets/vendor-0c76c893.js","assets/index-119c32a5.js"]));c.lazy(()=>y(()=>import("./index-69d1154d.js"),["assets/index-69d1154d.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-783cfa5e.js"),["assets/index-783cfa5e.js","assets/vendor-0c76c893.js","assets/index-119c32a5.js"]));c.lazy(()=>y(()=>import("./index-a98cda21.js"),["assets/index-a98cda21.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>import("./index-d07924f0.js"),["assets/index-d07924f0.js","assets/vendor-0c76c893.js"]));c.lazy(()=>y(()=>Promise.resolve().then(()=>Du),void 0));const T="/applications",ru="/application-for-superior-room",ou="/acad-performance",lu="/dormitory",Rs=T+"/clarification-of-passport-data",Is=T+"/arbitrary-request",Ns=T+"/social-scollarship",Ls=T+"/certificate-of-attendance",Ds=T+"/social-agencies",zs=T+"/paper-call",Ms=T+"/regular-accommodation",Fs=T+"/full-time-part-time-form",Us=T+"/accommodation-correspondence-form",Bs=T+"/academic-leave-accommodation",Hs=T+"/preferential-accommodation",Ws=T+"/family-room",Vs=T+"/termination-of-employment-contract",Gs=T+"/relocation-inside-hostel",qs=T+"/relocation-to-another-hostel",Jt=T+"/payment-recipient",Ys=T+"/restoring-the-magnetic-pass",Ks=T+"/retake-for-diploma",Js=T+"/military-registration-documents",Xs=T+"/financial-support",Zs=T+"/financial-assistance",Qs=T+"/increased-state-academic-scholarship",ea=T+"/changing-personal-data",ta=T+"/student-status",na=T+"/state-accreditation",cu=T+"/military-registration-card",ia=T+"/holidays-after-training",sa=T+"/provision-academic-leave",aa=T+"/independently-deducted",ra=T+"/extension-attestation",je=()=>ce({oldVersionUrl:"/sprav"}),Ne=()=>({applications:{id:"applications",title:"Цифровые сервисы",icon:n.jsx(A,{}),path:T,Component:Lp,color:"red",isTemplate:!1,group:"OTHER"},...Tr,dormitory:{id:"dormitory",title:"Общежитие",icon:n.jsx(jn,{}),path:lu,Component:$p,color:"blue",isTemplate:!1,group:"FINANCES_DOCS",show:!0},"acad-performance":{id:"acad-performance",title:"Успеваемость",icon:n.jsx(Hr,{}),path:ou,Component:Pp,color:"green",isTemplate:!1,group:"LEARNING_ACTIVITIES"},"project-activity":{id:"project-activity",title:"Проектная деятельность",icon:n.jsx(ji,{}),path:yn,Component:Dp,color:"orange",isTemplate:!1,group:"LEARNING_ACTIVITIES"},"helpful-information":{id:"helpful-information",title:"Полезная информация",icon:n.jsx(Wr,{}),path:jr,Component:fn,color:"blue",isTemplate:!0,group:"GENERAL"},"application-for-superior-room":{id:"application-for-superior-room",title:"Заявка на комнату повышенной комфортности",icon:n.jsx(jn,{}),path:ru,Component:Op,color:"blue",isTemplate:!1,group:"GENERAL",show:!1}}),Xt=()=>({...Er,"clarification-of-passport-data":{id:"clarification-of-passport-data",title:"Уточнение паспортных данных",icon:n.jsx(Tn,{}),path:Rs,Component:Ap,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"arbitrary-request":{id:"arbitrary-request",title:"Произвольный запрос",icon:n.jsx(Tn,{}),path:Is,Component:eu,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"social-scollarship":{id:"social-scollarship",title:"Социальная стипендия",icon:n.jsx(I,{}),path:Ns,Component:je,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"certificate-of-attendance":{id:"certificate-of-attendance",title:"Сертификат об обучении",icon:n.jsx(I,{}),path:Ls,Component:Cp,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"social-agencies":{id:"social-agencies",title:"Справка в социальные учреждения",icon:n.jsx(I,{}),path:Ds,Component:Rp,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"paper-call":{id:"paper-call",title:"Справка-вызов",icon:n.jsx(I,{}),path:zs,Component:Ip,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"regular-accommodation":{id:"regular-accommodation",title:"Предоставление права проживания (очная форма)",icon:I,path:Ms,Component:Np,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"full-time-part-time-form":{id:"full-time-part-time-form",title:"Предоставление права проживания (очно-заочная форма)",icon:I,path:Fs,Component:Ep,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"accommodation-correspondence-form":{id:"accommodation-correspondence-form",title:"Предоставление права проживания (заочная форма)",icon:I,path:Us,Component:Zp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"academic-leave-accommodation":{id:"academic-leave-accommodation",title:"Предоставление права проживания в период академического отпуска",icon:I,path:Bs,Component:zp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"preferential-accommodation":{id:"preferential-accommodation",title:"Предоставление права проживания льготной категории граждан",icon:I,path:Hs,Component:Mp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"family-room":{id:"family-room",title:"Предоставление права проживания в семейной комнате",icon:I,path:Ws,Component:Qp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"termination-of-employment-contract":{id:"termination-of-employment-contract",title:"Расторжение договора найма",icon:I,path:Vs,Component:Fp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"relocation-inside-hostel":{id:"relocation-inside-hostel",title:"Переселение внутри общежития",icon:I,path:Gs,Component:Up,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"relocation-to-another-hostel":{id:"relocation-to-another-hostel",title:"Переселение в другое общежитие (Подача заявок доступна с 08.06.2023 по 15.06.2023)",icon:I,path:qs,Component:je,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"payment-recipient":{id:"payment-recipient",title:"Отправка квитанции об оплате",icon:I,path:Jt,Component:Bp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"restoring-the-magnetic-pass":{id:"restoring-the-magnetic-pass",title:"Запрос на восстановление магнитного пропуска",icon:I,path:Ys,Component:Hp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"military-registration-documents":{id:"military-registration-documents",title:"Отправить документы воинского учета",icon:I,path:Js,Component:je,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"retake-for-diploma":{id:"retake-for-diploma",title:"Заявление на пересдачу для получения диплома с отличием",icon:I,path:Ks,Component:Wp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"increased-state-academic-scholarship":{id:"increased-state-academic-scholarship",title:"Получение повышенной государственной академической стипендии",icon:I,path:Qs,Component:je,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"financial-support":{id:"financial-support",title:"Оформить материальную поддержку остронуждающимся студентам (Дотацию)",icon:I,path:Xs,Component:je,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"financial-assistance":{id:"financial-assistance",title:"Финансовая поддержка",icon:I,path:Zs,Component:je,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"changing-personal-data":{id:"changing-personal-data",title:"Запрос на изменение персональных данных",icon:I,path:ea,Component:Vp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"student-status":{id:"student-status",title:"Справка о прохождении обучения в университете (о статусе обучающегося) по месту требования",icon:I,path:ta,Component:Gp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"state-accreditation":{id:"state-accreditation",title:"Выдача лицензий и свидетельств о государственной аккредитации",icon:I,path:na,Component:qp,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T},"holidays-after-training":{id:"holidays-after-training",title:"Предоставление каникул",icon:n.jsx(I,{}),path:ia,Component:Yp,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"provision-academic-leave":{id:"provision-academic-leave",title:"Предоставление академического отпуска",icon:n.jsx(I,{}),path:sa,Component:Kp,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"independently-deducted":{id:"independently-deducted",title:"Отчисление по инициативе обучающегося",icon:n.jsx(I,{}),path:aa,Component:Jp,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"extension-attestation":{id:"extension-attestation",title:"Продление промежуточной аттестации ",icon:n.jsx(I,{}),path:ra,Component:Xp,color:"blue",isTemplate:!1,group:"OTHER",isSubPage:!0,backButtonText:"Назад к цифровым сервисам",subPageHeaderTitle:"",fallbackPrevPage:T},"military-registration-card":{id:"military-registration-card",title:"Заполнить личную карточку обучающегося по воинскому учету для получения отсрочки от призыва на военную службу",icon:I,path:cu,Component:je,color:"blue",isTemplate:!1,isSubPage:!0,backButtonText:"Назад к заявлениям",subPageHeaderTitle:"",fallbackPrevPage:T}});let oa;const du=e=>{oa=e},Mx=()=>oa,pu=(e,t)=>{const[i,s]=c.useState(!1),[a,r]=c.useState(null);return c.useEffect(()=>{i&&setTimeout(()=>{s(!1),t(null)},200)},[i]),c.useEffect(()=>{setTimeout(()=>{a!==null&&(r(null),t(o=>(o&&delete o[a],{...o})))},500)},[a]),{removeAll:i,removeOne:a,setRemoveAll:s,setRemoveOne:r}},Ut=x.div`
...
`,wu=({title:e,obj:t,columns:i})=>n.jsxs(yu,{children:[n.jsx(U,{size:3,align:"left",bottomGap:!0,children:e}),i.map(s=>n.jsx(De,{keyStr:s.title,value:s.render?s.render(t[s.field],t):ye(t[s.field],s.type)},s.title))]}),ua=({columns:e,el:t,index:i,onRowClick:s})=>{const{open:a}=J(),r=()=>a(n.jsx(wu,{title:"Информация",obj:t,columns:e}));return n.jsx(fu,{even:i%2===0,onClick:()=>s?s(t):r(),children:e.map(o=>{var l;return n.jsx(da,{showFull:o.showFull,width:o.width,className:((l=o.priority)==null?void 0:l.toString())??"one",align:o.align,children:o.render?o.render(ye(t[o.field],o.type),t):ye(t[o.field],o.type)},o.field)})})},_u=x.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,ku=e=>{switch(e){case"date":return"date";case"rub":return"number";default:return"text"}},Su=({search:e,setSearch:t})=>{var i,s;return n.jsx(Eu,{closed:!(e!=null&&e.column),children:n.jsx(he,{value:(e==null?void 0:e.value)??"",setValue:a=>t(r=>r?(r.value=a,{...r}):null),width:"100%",type:ku((i=e==null?void 0:e.column)==null?void 0:i.type),placeholder:(s=e==null?void 0:e.column)==null?void 0:s.title,leftIcon:n.jsx(pt,{}),minWidth:"auto"})})},Ou=(e,t)=>{if(!e)return{};const i=t.reduce((s,{field:a})=>(s[a]=[],s),{});return e==null||e.forEach(s=>{Object.entries(s).forEach(([a,r])=>{i[a]&&r&&i[a].push(r)})}),i};function Pu(e){return Object.keys(e).map(t=>({title:"",field:t}))}const $u=({footer:e,columns:t,data:i})=>{if(!e)return null;const s=e(Ou(i,t));return n.jsxs(n.Fragment,{children:[n.jsx(ue,{}),n.jsx(ua,{onRowClick:()=>null,columns:Pu(s),el:s,index:1})]})},Au=x.div`
    ...
    background: var(--form);
    overflow: hidden;
`,ni=({columns:e,data:t,maxOnPage:i,onRowClick:s,footer:a,loading:r=!1})=>{const{sort:o,setSort:l,search:d,setSearch:p,resultData:u,filter:m,setFilter:b,filterList:h,setFilterList:g,onRemoveOne:f,onRemoveAll:v}=gu(t);return n.jsxs(Au,{children:[n.jsx(la,{setList:g,padding:"0 10px",list:h,onRemoveOne:f,onRemoveAll:v}),n.jsx(Su,{search:d,setSearch:p}),n.jsx(bu,{sort:o,setSort:l,columns:e,search:d,setSearch:p,filter:m,setFilter:b}),n.jsx(Tu,{loading:r,onRowClick:s,filter:m,columns:e,data:u,maxOnPage:i}),n.jsx($u,{footer:a,data:t,columns:e})]})},jt={ready:"Готово",pending:"В работе",rejected:"Отклонено"},Cu={agreeding:"На согласовании",notAgreed:"Не согласовано",agreed:"Согласовано",empty:"Не создано",rejected:"Отклонено"},Ru={signed:"Подписан",agreeding:"На согласовании",fixing:"На доработке",empty:"Не создан"},Fx=[{id:1,title:"1"},{id:2,title:"2"},{id:3,title:"3"}],Ux=[{id:0,title:"На электронную почту"},{id:1,title:"Лично"},{id:3,title:"На почтовый адрес"}],ii=()=>[{title:"Статус заявления",field:"status",priority:"one",width:"200px",catalogs:[...Object.values(Cu).map((e,t)=>({id:t.toString(),title:e}))??[]],render:e=>n.jsx(K,{type:e==="Готово"?"success":e==="Отклонено"?"failure":"alert",title:e,align:"center",width:"100%",icon:null,maxWidth:"150px"})},{title:"Дата подписи",field:"signDate",type:"date",priority:"one",align:"center"},{title:"Номер приказа",field:"orderNumber",priority:"one",align:"center"},{title:"Дата приказа",field:"orderDate",type:"date",priority:"one",align:"center",render:e=>n.jsx(K,{type:e==="Готово"?"success":e==="Отклонено"?"failure":"alert",title:e,align:"center",width:"100%",icon:null,maxWidth:"150px"})},{title:"Статус приказа",field:"orderStatus",priority:"one",width:"200px",catalogs:[...Object.values(Ru).map((e,t)=>({id:t.toString(),title:e}))??[]],render:e=>n.jsx(K,{type:e==="Готово"?"success":e==="Отклонено"?"failure":"alert",title:e,align:"center",width:"100%",icon:null,maxWidth:"150px"})},{title:"Файл заявления",priority:"one",field:"file",type:"file"},{title:"Примечание",field:"registrationStatus",priority:"one"}],Iu=x.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`,Xu=(e,t=265,i=200)=>(e.preventDefault(),{x:e.clientX<window.innerWidth/2?e.clientX:e.clientX-t,y:e.clientY<window.innerHeight/2?e.clientY:e.clientY-i}),Zu={open:!1,content:null,type:"left-click",position:{x:0,y:0}},Qu=()=>Jr(eh),qa=k(),Ya=k(),Ka=k(),eh=W(Zu).on(qa,(e,{content:t,e:i,height:s,type:a="left-click"})=>({position:Xu(i,220,s),open:!0,content:t,type:a})).on(Ya,e=>({...e,open:!1})).on(Ka,(e,{position:t})=>({...e,position:t})),ie={open:qa,close:Ya,changePosition:Ka},th={useContextMenu:Qu},en=x.span`
    color: #fff;
...
`;function qe({selected:e,name:t,avatar:i,width:s,height:a,marginRight:r,notifications:o,checked:l,boxShadow:d,border:p,avatarModal:u}){const[m,b]=c.useState(!0),h=tn(t)[0]+(tn(t)[1]??""),{open:g}=J(),f=()=>{u&&g(n.jsx(qe,{name:t,width:"400px",height:"400px",marginRight:"0",avatar:i}))};return n.jsxs(nh,{selected:e,width:s,height:a,marginRight:r,background:ae(t),boxShadow:d,border:p,onClick:f,children:[i&&m?n.jsx(ih,{round:!0,onLoadedData:()=>b(!0),onError:()=>b(!1),src:i}):n.jsx("div",{className:"name",children:h}),n.jsx(ve,{invisibleOnFalse:!0,checked:l??!1,visible:l!==void 0,setChecked:()=>null}),n.jsx(en,{left:"80%",top:"90%",outline:"4px solid var(--schedule)",visible:!!o,children:o})]})}const sh=()=>n.jsx(Y,{to:ge,children:n.jsx(j,{text:"Настройки",icon:n.jsx(an,{}),onClick:()=>ie.close(),width:"100%",align:"left",background:"var(--schedule)"})}),ah=x.div`
    .user-info-plate {
        display: flex;
        flex-direction: column;
        width: 100%;
...
`,rh=()=>{const e=Et.logout,{data:{user:t}}=Q.useUser(),{open:i}=J(),{theme:s,switchTheme:a}=gt(),[r,o]=c.useState([{title:"Темная тема",state:s!=="light",action:d=>a(d)}]),l=()=>ie.close();return c.useEffect(()=>{o([{title:"Темная тема",state:s!=="light",action:d=>a(d)}])},[s]),t?n.jsxs(ah,{children:[n.jsxs("div",{className:"user-info-plate",children:[n.jsxs("div",{className:"avatar-and-name",children:[n.jsx(qe,{name:Ue({name:t.name,patronymic:t.patronymic,surname:t.surname}),avatar:t==null?void 0:t.avatar,width:"35px",height:"35px",marginRight:"8px"}),n.jsx("b",{children:Ue({name:t.name,surname:t.surname,patronymic:t.patronymic})})]}),n.jsx("div",{className:"buttons"})]}),n.jsx(As,{title:"",toggles:r,setToggles:o}),n.jsx(sh,{}),n.jsx(j,{text:"Что нового",icon:n.jsx(Xr,{}),onClick:()=>{l(),i(n.jsx(xn,{}))},width:"100%",align:"left",background:"var(--schedule)"}),n.jsx(un,{text:"Cтарый дизайн",onClick:()=>{localStorage.setItem("useOldVersion","true")},background:"var(--schedule)",icon:n.jsx(rn,{}),width:"100%",align:"left",href:`${de}/index.php`}),n.jsx(ue,{}),n.jsx(j,{align:"left",icon:n.jsx(ki,{}),onClick:()=>{l(),pe.evokeConfirm({message:"Вы точно хотите выйти из аккаунта?",onConfirm:e})},text:"Выйти",width:"100%",background:"var(--schedule)"})]}):null},oh=x.div`
    width: 60px;
    display: flex;
    align-items: center;
...
`,dh=()=>{const{data:{user:e}}=Q.useUser(),t=c.useRef(null),i=s=>{ie.open({e:s,content:n.jsx(rh,{}),height:200})};return e?n.jsx(ch,{ref:t,tabIndex:1,children:n.jsxs("div",{className:"user-info-plate",onClick:i,children:[n.jsx(qe,{name:Ue({name:e.name,patronymic:e.patronymic,surname:e.surname}),avatar:e==null?void 0:e.avatar,width:"32px",height:"32px",marginRight:"5px"}),n.jsx(Zr,{})]})}):n.jsx(lh,{})},ph=({visible:e=!0,text:t="Назад",fullWidth:i=!0})=>{if(!e)return null;const s=dt();return n.jsx(j,{text:t,onClick:()=>s.goBack(),icon:n.jsx(Qr,{}),textColor:"var(--reallyBlue)",background:"transparent",width:i?"100%":void 0,padding:"0",height:"20px",align:"left"})},uh=({currentPagePair:{currentPage:e,exactCurrentPage:t}})=>{var d;const i=dt(),s=hd(),{width:a}=Ge(),r=(p=fr)=>()=>{xt.changeOpen({isOpen:!1,currentPage:p.slice(1,p.length)}),i.push(p)},o=G.useMemo(()=>t?t.isSubPage?t.subPageHeaderTitle:t.title:e==null?void 0:e.title,[e,t]),l=G.useMemo(()=>t!=null&&t.withoutBackButton?null:t!=null&&t.isSubPage?s.length>1?n.jsx(ph,{text:t==null?void 0:t.backButtonText,fullWidth:!1}):t.fallbackPrevPage?n.jsx(j,{icon:n.jsx(zt,{}),onClick:r(t.fallbackPrevPage),background:"transparent"}):n.jsx(j,{icon:n.jsx(zt,{}),onClick:r(),background:"transparent"}):n.jsx(j,{icon:n.jsx(zt,{}),onClick:r(),background:"transparent"}),[t,s,r]);return n.jsxs(Ju,{hidden:(d=t??e)==null?void 0:d.withoutHeader,children:[n.jsxs("div",{className:"header-button-and-title",children:[l,n.jsx("div",{className:"title-container",children:n.jsx("h3",{children:o})})]}),a<=1e3&&n.jsx(dh,{})]})},hh=G.memo(uh),gh=()=>{const{open:e}=J(),t=()=>ie.close(),i=()=>{pe.evokeConfirm({message:"Вы точно хотите выйти из аккаунта?",onConfirm:Et.logout}),t()},s=()=>{ie.close(),e(n.jsx(xn,{}))};return n.jsxs(n.Fragment,{children:[n.jsx(Y,{to:ge,children:n.jsx(j,{text:"Настройки",background:"var(--schedule)",icon:n.jsx(an,{}),width:"100%",align:"left",onClick:t})}),n.jsx("a",{href:`${de}/index.php`,children:n.jsx(j,{text:"Старый дизайн",icon:n.jsx(rn,{}),width:"100%",background:"var(--schedule)",align:"left"})}),n.jsx(ue,{}),n.jsx(j,{align:"left",icon:n.jsx(ki,{}),onClick:i,text:"Выйти",width:"100%",background:"var(--schedule)"}),n.jsx(ue,{}),n.jsx(j,{align:"left",icon:n.jsx(K,{icon:null,type:"info",title:"v2.1.0",width:"fit-content"}),onClick:s,text:"Что нового",width:"100%",background:"var(--schedule)"})]})},fh=x(Y)`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: 10px;
...
`,xh=({name:e,avatar:t,loading:i,size:s,notifications:a,selected:r})=>i?n.jsx(te,{shape:"circle",size:{width:"40px",height:"40px"}}):n.jsxs(fh,{to:xr,onClick:()=>xt.changeOpen({isOpen:!1,currentPage:"profile"}),children:[n.jsx(j,{icon:n.jsx(Si,{}),className:"more-button",background:"transparent",onClick:o=>{o.preventDefault(),o.stopPropagation(),ie.open({e:o,height:143,content:n.jsx(gh,{})})}}),n.jsx(qe,{notifications:a,width:s??"70px",height:s??"70px",avatar:t,name:e,marginRight:"0",selected:r}),n.jsx(U,{size:5,children:e})]}),mh=G.memo(xh),bh=["isCurrent","color"],vh=x(Y).withConfig({shouldForwardProp:e=>!bh.includes(e)})`
    position: relative;
    display: flex;
    align-items: center;
...
`;const Nh=()=>{const{leftsideBarRoutes:e,currentPage:t}=we.useMenu(),i=c.useMemo(()=>{const s=window.location.hash.split("/");return s.length>2&&s[1]?s[1]:t==null?void 0:t.id},[t]);return e?n.jsx(wh,{children:Object.values(e).filter(s=>s!==void 0).map(s=>c.createElement(Ja,{...s,key:s==null?void 0:s.id,isCurrent:i===(s==null?void 0:s.id)}))}):n.jsx(te,{shape:"rect",size:{width:"100%",height:"300px"}})},Lh=G.memo(Nh),Dh=()=>{const{isOpen:e}=we.useMenu(),{width:t,height:i}=Ge(),{data:{user:s}}=Q.useUser(),{visibleRoutes:a,currentPage:r}=we.useMenu(),{theme:o,switchTheme:l}=gt(),[d,p]=c.useState([{title:"Темная тема",state:o!=="light",action:u=>l(u)}]);return c.useEffect(()=>{p([{title:"Темная тема",state:o!=="light",action:u=>l(u)}])},[o]),n.jsxs(yh,{isOpen:e,height:i,children:[n.jsxs("div",{className:"top-wrapper",children:[n.jsx(Y,{to:bn,children:n.jsx(At,{width:"165px"})}),n.jsx(mh,{notifications:a==null?void 0:a.profile.notifications,avatar:s==null?void 0:s.avatar,name:(s==null?void 0:s.fullName)??"",loading:!s,selected:(r==null?void 0:r.id)==="profile"}),n.jsx(Lh,{})]}),n.jsx(As,{title:"",toggles:d,setToggles:p}),t<1e3&&n.jsx(Rh,{})]})},zh=x.div`
    width: 300px;
    position: absolute;
    bottom: 20px;
    right: 20px;
...
`,Mh=()=>{const{isOpen:e,message:t,type:i,time:s,onClick:a}=os.usePopUpMessage();c.useEffect(()=>{e&&setTimeout(()=>{z.openPopUpMessage({isOpen:!e})},s)},[e]);const r=c.useCallback(()=>{a&&(a(),z.openPopUpMessage({isOpen:!e}))},[a]);return n.jsx(zh,{isOpen:e,isClickable:!!a,color:ke[i].color,onClick:r,children:n.jsx(K,{type:i,fontSize:"1em",onClose:()=>z.openPopUpMessage({isOpen:!1}),children:t})})},Fh=()=>{const{isOpen:e,component:t,canBack:i,back:s,close:a}=c.useContext(ln);return{back:s,close:a,isOpen:e,canBack:i,component:t}},Uh=x.div`
    background: var(--theme);
    color: var(--text);
    padding: 20px;
    min-height: 150px;
...
`,Gh=()=>{const{isOpen:e,message:t,onConfirm:i,onReject:s}=Ji.useConfirm(),a=c.useRef(null);We(a,()=>pe.closeConfirm());const r=()=>{i(),pe.closeConfirm()},o=()=>{pe.closeConfirm()};return n.jsx(Rt,{isOpen:e,children:n.jsxs(Vh,{isOpen:e,ref:a,children:[n.jsx(U,{size:3,align:"left",children:t??"Хотите продолжить?"}),n.jsxs(se,{width:"100%",scroll:!1,direction:"horizontal",gap:5,padding:"10px 0 0 0",horizontalAlign:"right",children:[n.jsx(j,{text:"Да",onClick:r,width:"90px",textColor:_.red.main,background:"transparent",hoverBackground:_.red.transparent3}),n.jsx(j,{text:"Нет",onClick:s??o,width:"90px",textColor:_.blue.main,background:"transparent",hoverBackground:_.blue.transparent3})]})]})})},qh=x.div`
    display: flex;
...
`,og=({avatar:e,name:t,type:i,division:s,group:a,finance:r,educationForm:o,degreeLevel:l,course:d,isMe:p=!1,noInfo:u=!1})=>{const m=u?"140px":"110px",b=Za(p,i,s,a);return n.jsxs(rg,{children:[n.jsx(ag,{fullName:t,avatar:e,height:"136px",width:"calc(100% + 16px)",baseScale:1,baseScaleDelta:.5}),n.jsx(qe,{avatarModal:!0,border:!0,name:t,avatar:e,width:m,height:m,marginRight:"0"}),!u&&n.jsxs("div",{className:"info",children:[n.jsx("b",{children:t}),n.jsx(Ve,{fontSize:"0.9rem",children:n.jsx(Xa,{words:b})}),n.jsx(De,{fontSize:"0.9rem",visible:!!r,keyStr:"Уровень финансирование",value:r}),n.jsx(De,{fontSize:"0.9rem",visible:!!l,keyStr:"Уровень образования",value:l}),n.jsx(De,{fontSize:"0.9rem",visible:!!d,keyStr:"Курс",value:d}),n.jsx(De,{fontSize:"0.9rem",visible:!!o,keyStr:"Форма образования",value:o})]})]})},lg=x.div`
    @media (min-width: 1001px) {
        width: 330px;
        height: fit-content;
        min-height: 120px;
...
`,Qa=e=>{const{children:t}=e;return n.jsxs(lg,{children:[n.jsx(og,{...e}),n.jsx("div",{className:"buttons",children:t})]})},cg=x.div`
    display: flex;
    align-items: center;
    .name-and-status {
        display: flex;
...
`,dg=()=>n.jsxs(cg,{children:[n.jsx(te,{shape:"circle",size:{width:"30px",height:""},margin:"8px 0px 8px 0 "}),n.jsxs("div",{className:"name-and-status",children:[n.jsx(te,{shape:"rect",size:{width:"130px",height:"10px"},margin:"1px 10px"}),n.jsx(te,{shape:"rect",size:{width:"70px",height:"8px"},margin:"0px 10px"})]})]}),er=e=>{if(e)return()=>{pe.evokeConfirm({message:"Вы уверены, что хотите сменить аккаунт?",onConfirm:()=>{localStorage.setItem("token",JSON.stringify({token:e})),location.reload()}})}},pg=e=>{const{close:t}=J(),{token:i,name:s,group:a}=e,r=`linear-gradient(45deg, ${ae(s,"main")}, ${ae(s,"dark1")})`;return n.jsxs(Qa,{...e,type:"stud",children:[!i&&n.jsxs(n.Fragment,{children:[n.jsx(Y,{to:`${It}/${a}`,children:n.jsx(j,{icon:n.jsx(Oi,{}),text:"Расписание",onClick:()=>t(),width:"100%"})}),n.jsx(j,{icon:n.jsx(Pi,{}),text:"Написать",onClick:()=>t(),width:"100%",isActive:!1})]}),i&&n.jsx(j,{text:"Войти в аккаунт",width:"100%",textColor:"#fff",background:r,onClick:er(i)})]})},tr=e=>{const{close:t}=J(),{token:i,name:s}=e,a=`linear-gradient(45deg, ${ae(s,"dark1")}, ${ae(s,"main")})`;return n.jsxs(Qa,{type:"staff",...e,children:[!i&&n.jsxs(n.Fragment,{children:[n.jsx(Y,{to:`${It}/${s}`,children:n.jsx(j,{icon:n.jsx(Oi,{}),text:"Расписание",onClick:()=>{t()},width:"100%"})}),n.jsx(j,{icon:n.jsx(Pi,{}),text:"Написать",onClick:()=>t(),width:"100%",isActive:!1})]}),i&&n.jsx(j,{text:"Войти в аккаунт",width:"100%",textColor:"#fff",background:a,onClick:er(i)})]})},ug=x.div`
    display: flex;
    align-items: center;
...
`,Wx=e=>{const{open:t}=J(),{type:i,avatar:s,name:a,checked:r,onClick:o,indexNumber:l,division:d,group:p,isMe:u=!1,loading:m=!1,orientation:b="horizontal",size:h="middle"}=e,g=Za(u,i,d,p);if(m)return n.jsx(dg,{});const f=v=>{o?o(v):u||t(i==="staff"?n.jsx(tr,{...e}):n.jsx(pg,{...e}))};return n.jsxs(ug,{orientation:b,size:h,onClick:f,children:[l&&n.jsx("div",{className:"index",children:l}),n.jsx(qe,{name:a,avatar:s,width:hi(b,h),height:hi(b,h),marginRight:b==="horizontal"?"7px":"0px",checked:r}),n.jsxs("div",{className:"name-and-status",children:[n.jsx("span",{className:"name",children:a}),n.jsx("span",{className:"status",children:n.jsx(Xa,{words:g})})]})]})},hg=x.div`
    display: flex;
    align-items: center;
    flex-direction: column;
    padding: 15px 20px;
...
`,gg=({icon:e,title:t,color:i,goTo:s,visible:a=!0})=>{const{close:r}=J();return a?n.jsxs(hg,{color:i,children:[n.jsx("div",{className:"icon",children:e}),n.jsx("span",{className:"title",children:t}),!!s&&n.jsx(Y,{to:s,children:n.jsx(j,{text:"Перейти",onClick:r,background:"var(--almostTransparent)",width:"100%"})})]}):null},fg=x.div`
    width: 100%;
    height: 100%;
    display: flex;
    align-items: center;
...
`,vg=()=>{const{allRoutes:e,currentPage:t}=we.useMenu();return e?n.jsx(gi,{direction:"horizontal",horizontalAlign:"evenly",children:Vu.map(i=>n.jsx(Ja,{...e[i],isCurrent:(t==null?void 0:t.id)===i},i))}):n.jsxs(gi,{direction:"horizontal",horizontalAlign:"evenly",verticalAlign:"center",children:[n.jsx(te,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"}),n.jsx(te,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"}),n.jsx(te,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"}),n.jsx(te,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"}),n.jsx(te,{shape:"rect",size:{width:"55px",height:"40px"},margin:"0"})]})},yg=(e,t,i)=>({isOpen:t,message:e,position:i}),fi={hints:[]},wg=()=>P(_g),nr=k(),ir=k(),sr=k(),_g=W(fi).on(nr,(e,{message:t,position:i})=>({hints:[...e.hints,yg(t,e.hints.length===0,i)]})).on(ir,e=>({hints:e.hints.splice(1,e.hints.length)})).on(sr,()=>({...fi})),jg={useHint:wg},Tg={evoke:nr,close:ir,clearStore:sr},Eg=x.div`
    left: ${({left:e})=>e+"px"};
    top: ${({top:e})=>e+"px"};
    /* padding: 10px; */
    background: var(--reallyBlue);
...
`,kg=()=>{const{hints:e}=jg.useHint(),t=e[0];return t?n.jsx(Eg,{open:t.isOpen,left:t.position.x,top:t.position.y,children:n.jsx(K,{type:"hint",title:t.message,onClose:()=>Tg.close(),width:"100%",icon:null})}):null},Sg=x.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    overflow: auto;
...
`,Bg=x.div`
    display: flex;
    align-items: center;
`,Hg=({columns:e,search:t,setSearch:i,filter:s,setFilter:a,sort:r,setSort:o})=>n.jsx(Ug,{children:e.map(l=>{var d,p,u,m;return n.jsxs(rr,{overflow:l.catalogs?"visible":"hidden",width:l.width,title:l.title,clickable:l.search,align:l.search?"space-between":l.align,showFull:l.showFull,className:((d=l.priority)==null?void 0:d.toString())??"one",onClick:()=>{l.search&&i({value:"",column:l}),l.sort&&o(b=>{const h=b!=null&&b.value?b.value==="desc"?"asc":null:"desc";return ca(h),h?{column:l,value:h}:null})},children:[!l.catalogs&&l.title,!l.catalogs&&!l.sort&&l.search&&n.jsx(pt,{className:"icon",style:{color:l.field===((p=t==null?void 0:t.column)==null?void 0:p.field)?"var(--reallyBlue)":"var(--text)"}}),l.sort&&n.jsx(Ti,{className:"icon",style:{color:l.field===((u=r==null?void 0:r.column)==null?void 0:u.field)?"var(--reallyBlue)":"var(--text)"}}),l.catalogs&&n.jsx(Bg,{children:n.jsx(gn,{appearance:!1,items:l.catalogs??[],setSelected:b=>a(h=>(b&&(h={...h,[l.field]:{column:l,value:b}}),h)),selected:(m=s==null?void 0:s[l.field])==null?void 0:m.value,placeholder:l.title})})]},l.title)})}),Wg=x.div`
    @media (min-width: 1001px) {
        max-width: 500px;
    }
`,Vg=({title:e,obj:t,columns:i})=>n.jsxs(Wg,{children:[n.jsx(U,{size:3,align:"left",bottomGap:!0,children:e}),i.map(s=>n.jsx(De,{keyStr:s.title,value:s.render?s.render(t[s.field],t):ye(t[s.field],s.type)},s.title))]}),or=({columns:e,el:t,index:i,onRowClick:s})=>{const{open:a}=J(),r=()=>a(n.jsx(Vg,{title:"Информация",obj:t,columns:e}));return n.jsx(Fg,{even:i%2===0,onClick:()=>s?s(t):r(),children:e.map(o=>{var l;return n.jsx(rr,{showFull:o.showFull,width:o.width,className:((l=o.priority)==null?void 0:l.toString())??"one",align:o.align,children:o.render?o.render(ye(t[o.field],o.type),t):ye(t[o.field],o.type)},o.field)})})},Gg=x.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,Jg=e=>{switch(e){case"date":return"date";case"rub":return"number";default:return"text"}},Xg=({search:e,setSearch:t})=>{var i,s;return n.jsx(Kg,{closed:!(e!=null&&e.column),children:n.jsx(he,{value:(e==null?void 0:e.value)??"",setValue:a=>t(r=>r?(r.value=a,{...r}):null),width:"100%",type:Jg((i=e==null?void 0:e.column)==null?void 0:i.type),placeholder:(s=e==null?void 0:e.column)==null?void 0:s.title,leftIcon:n.jsx(pt,{}),minWidth:"auto"})})},Zg=(e,t)=>{if(!e)return{};const i=t.reduce((s,{field:a})=>(s[a]=[],s),{});return e==null||e.forEach(s=>{Object.entries(s).forEach(([a,r])=>{i[a]&&r&&i[a].push(r)})}),i};function Qg(e){return Object.keys(e).map(t=>({title:"",field:t}))}const ef=({footer:e,columns:t,data:i})=>{if(!e)return null;const s=e(Zg(i,t));return n.jsxs(n.Fragment,{children:[n.jsx(ue,{}),n.jsx(or,{onRowClick:()=>null,columns:Qg(s),el:s,index:1})]})},tf=x.div`
    ...
    background: var(--form);
    overflow: hidden;
`,nf=({columns:e,data:t,maxOnPage:i,onRowClick:s,footer:a,loading:r=!1})=>{const{sort:o,setSort:l,search:d,setSearch:p,resultData:u,filter:m,setFilter:b,filterList:h,setFilterList:g,onRemoveOne:f,onRemoveAll:v}=Mg(t);return n.jsxs(tf,{children:[n.jsx(la,{setList:g,padding:"0 10px",list:h,onRemoveOne:f,onRemoveAll:v}),n.jsx(Xg,{search:d,setSearch:p}),n.jsx(Hg,{sort:o,setSort:l,columns:e,search:d,setSearch:p,filter:m,setFilter:b}),n.jsx(Yg,{loading:r,onRowClick:s,filter:m,columns:e,data:u,maxOnPage:i}),n.jsx(ef,{footer:a,data:t,columns:e})]})},sf=x.div`
    display: flex;
    align-items: center;
    color: var(--text);
    justify-content: center;
...
`;x(ft)`
    ...
    height: 100%;
    padding: 20px;
`;const xi={isOpen:!1,pages:[],currentPage:0},lf=()=>P(cf),lr=k(),cr=k(),dr=k(),pr=k(),cf=W(xi).on(lr,(e,{pages:t})=>({isOpen:!0,pages:t,currentPage:0})).on(cr,e=>({pages:e.pages,currentPage:e.currentPage,isOpen:!1})).on(dr,(e,{value:t})=>({...e,currentPage:t})).on(pr,()=>({...xi})),mn={useStory:lf},Te={open:lr,close:cr,clearStore:pr,changeCurrentPage:dr};x($t)`
    overflow: hidden;
    position: relative;
    background: ${({background:e})=>e??"var(--schedule)"};
    cursor: pointer;
...
`,Yx=({fio:e})=>{const{open:t}=J();return n.jsx(df,{onClick:()=>t(n.jsx(tr,{name:e,isMe:!1})),children:e})},Kx=x.div`
    display: flex;
    align-items: ${({alignItems:e})=>e??"center"};
    justify-content: center;
...
`,bf=()=>n.jsx(mf,{children:n.jsx(xf,{})}),vf=c.lazy(()=>y(()=>import("./index-91f06390.js"),["assets/index-91f06390.js","assets/vendor-0c76c893.js","assets/page-link-2d3b3c59.js","assets/page-link-content-a074f185.js","assets/get-correct-word-form-c0a854e8.js","assets/get-short-string-60b0c4d4.js","assets/found-pages-76fae3b7.js","assets/search-f0f20efc.js","assets/links-list-965fd388.js"])),ur=c.lazy(()=>y(()=>import("./index-ea6fa557.js"),["assets/index-ea6fa557.js","assets/vendor-0c76c893.js","assets/student-api-ab728b47.js","assets/index-11db7722.js","assets/index-5e6bbadd.js","assets/index-012ca6bf.js"])),yf=c.lazy(()=>y(()=>import("./index-48a216eb.js"),["assets/index-48a216eb.js","assets/vendor-0c76c893.js","assets/index-11db7722.js","assets/index-5e6bbadd.js","assets/index-012ca6bf.js"])),wf=c.lazy(()=>y(()=>import("./index-5d04317b.js"),["assets/index-5d04317b.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js"]));c.lazy(()=>y(()=>import("./index-dd863c3d.js"),["assets/index-dd863c3d.js","assets/vendor-0c76c893.js","assets/index.esm-aaf37469.js"]));const _f=c.lazy(()=>y(()=>import("./index-794219c9.js"),["assets/index-794219c9.js","assets/vendor-0c76c893.js","assets/index-e694d6bf.js"])),hr=c.lazy(()=>y(()=>import("./index-36f0fdf1.js"),["assets/index-36f0fdf1.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js","assets/help-links-fedf5c27.js"])),jf=c.lazy(()=>y(()=>import("./index-7b542a8b.js"),["assets/index-7b542a8b.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js"])),Tf=c.lazy(()=>y(()=>import("./index-1bbab514.js"),["assets/index-1bbab514.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js","assets/get-short-string-60b0c4d4.js"])),Ef=c.lazy(()=>y(()=>import("./index-dbd50c35.js"),["assets/index-dbd50c35.js","assets/vendor-0c76c893.js","assets/links-list-965fd388.js","assets/page-link-2d3b3c59.js","assets/page-link-content-a074f185.js","assets/get-correct-word-form-c0a854e8.js","assets/get-short-string-60b0c4d4.js","assets/week-schedule-367450da.js","assets/index-8642c4bc.js","assets/qr-code-e15f492e.js","assets/index-012ca6bf.js"])),kf=c.lazy(()=>y(()=>import("./index-6ed1b9ab.js"),["assets/index-6ed1b9ab.js","assets/vendor-0c76c893.js","assets/teacher-data-6050d60a.js"])),Sf=c.lazy(()=>y(()=>import("./index-e89c4191.js"),["assets/index-e89c4191.js","assets/vendor-0c76c893.js","assets/qr-code-e15f492e.js","assets/index-e694d6bf.js","assets/index-012ca6bf.js"])),Of=c.lazy(()=>y(()=>import("./index-05233ff6.js"),["assets/index-05233ff6.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js"])),Pf=c.lazy(()=>y(()=>import("./index-31c6edc1.js"),["assets/index-31c6edc1.js","assets/vendor-0c76c893.js","assets/index-e9b73363.js","assets/week-schedule-367450da.js","assets/get-correct-word-form-c0a854e8.js","assets/get-short-string-60b0c4d4.js","assets/index-8642c4bc.js","assets/index-5e6bbadd.js","assets/student-api-ab728b47.js","assets/page-link-content-a074f185.js","assets/page-link-2d3b3c59.js","assets/found-pages-76fae3b7.js"])),$f=c.lazy(()=>y(()=>import("./index-70dae202.js"),["assets/index-70dae202.js","assets/vendor-0c76c893.js","assets/page-link-2d3b3c59.js","assets/page-link-content-a074f185.js","assets/get-correct-word-form-c0a854e8.js","assets/get-short-string-60b0c4d4.js","assets/found-pages-76fae3b7.js","assets/customize-leftside-bar-item-369223ba.js","assets/index.esm-aaf37469.js","assets/search-f0f20efc.js","assets/index-8642c4bc.js","assets/index-5c0d4f40.js"])),Af=c.lazy(()=>y(()=>import("./index-cd25e801.js"),["assets/index-cd25e801.js","assets/vendor-0c76c893.js"])),Cf=c.lazy(()=>y(()=>import("./index-6dcf3d10.js"),["assets/index-6dcf3d10.js","assets/vendor-0c76c893.js"])),Rf=c.lazy(()=>y(()=>import("./index-ba314516.js"),["assets/index-ba314516.js","assets/vendor-0c76c893.js","assets/customize-leftside-bar-item-369223ba.js","assets/page-link-content-a074f185.js","assets/get-correct-word-form-c0a854e8.js","assets/get-short-string-60b0c4d4.js","assets/index.esm-aaf37469.js"])),If=c.lazy(()=>y(()=>import("./index-fae476d6.js"),["assets/index-fae476d6.js","assets/vendor-0c76c893.js"])),Nf=c.lazy(()=>y(()=>import("./index-2c592dc2.js"),["assets/index-2c592dc2.js","assets/vendor-0c76c893.js","assets/index-e9b73363.js","assets/week-schedule-367450da.js","assets/get-correct-word-form-c0a854e8.js","assets/get-short-string-60b0c4d4.js","assets/index-8642c4bc.js","assets/index-5e6bbadd.js","assets/student-api-ab728b47.js","assets/page-link-content-a074f185.js","assets/page-link-2d3b3c59.js","assets/found-pages-76fae3b7.js"])),Lf=c.lazy(()=>y(()=>import("./index-ff1cd4ad.js"),["assets/index-ff1cd4ad.js","assets/vendor-0c76c893.js","assets/index-824b9df3.js","assets/index-012ca6bf.js"])),Df=c.lazy(()=>y(()=>import("./index-b82ebbe6.js"),["assets/index-b82ebbe6.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js"])),zf=c.lazy(()=>y(()=>import("./index-1e104c06.js"),["assets/index-1e104c06.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js","assets/help-links-fedf5c27.js"])),Mf=c.lazy(()=>y(()=>import("./index-a095282f.js"),["assets/index-a095282f.js","assets/vendor-0c76c893.js","assets/index-012ca6bf.js","assets/help-links-fedf5c27.js"])),Ff=c.lazy(()=>y(()=>import("./index-f94e8c9b.js"),["assets/index-f94e8c9b.js","assets/vendor-0c76c893.js"])),gr="/login",Uf="/forgot-password",Bf="/medical-certificate",fr="/all",bn="/home",xr="/profile",nn="/chat",Jx=nn+"/:chatId",Hf="/electronic-interaction-agreement",Wf="/payments",It="/schedule",mr="/all-students",Vf="/all-students/:filter",br="/all-teachers",vn="/feedback",vr="/cant-access",yr="/memo-freshmen",wr="/get-your-login",_r="/memo-teacher",ge="/settings",Xx=ge+"/:id",Gf=ge+"/appearance",qf=ge+"/personal",Yf=ge+"/security",Kf=ge+"/home-page",Jf=ge+"/customize-menu",Xf="/instructions",yn="/project-activity",wn="/alerts",jr="/helpful-information",Zf=It+"/:filter",Qf=jr+"/:infoType";var ex=(e=>(e.GENERAL="Основное",e.FINANCES_DOCS="Финансы и документы",e.LEARNING_ACTIVITIES="Учебная деятельность",e.OTHER="Находится в разработке",e.COMMUNICATION="Коммуникация",e))(ex||{});const tx=[{id:0,title:"",icon:"",path:gr,Component:bf},{id:1,title:"",icon:"",path:Uf,Component:jf},{id:2,title:"Обратная связь",icon:n.jsx(ot,{}),path:vn,Component:hr},{id:3,title:"Не получается войти в Личный кабинет",icon:n.jsx(Fe,{}),path:vr,Component:wf},{id:4,title:"Узнать свой логин ЕУЗ",icon:"",path:wr,Component:Df},{id:5,title:"Вниманию студентов 1 курса!",icon:"",path:yr,Component:zf},{id:6,title:"Вниманию сотрудников!",icon:"",path:_r,Component:Mf}],Tr={all:{id:"all",title:"Все разделы",icon:n.jsx(no,{}),path:fr,Component:vf,color:"lightGreen",isTemplate:!1,show:!1,group:"GENERAL",withoutBackButton:!0},settings:{id:"settings",title:"Настройки",icon:n.jsx(an,{}),path:ge,Component:$f,color:"grey",isTemplate:!0,show:!0,group:"GENERAL"},"electronic-interaction-agreement":{id:"electronic-interaction-agreement",title:"Соглашение об электронном взаимодействии",shortTitle:"Соглашение об электр...",icon:n.jsx(io,{}),path:Hf,Component:_f,color:"blue",isTemplate:!1,group:"FINANCES_DOCS"},payments:{id:"payments",title:"Договоры и оплаты",icon:n.jsx(so,{}),path:Wf,Component:Sf,color:"lightGreen",isTemplate:!1,group:"FINANCES_DOCS"},doclist:{id:"doclist",title:"Ознакомление с документами",shortTitle:"Ознакомление с док...",icon:n.jsx(A,{}),path:ha,Component:()=>n.jsx(Lf,{}),color:"blue",isTemplate:!1,group:"FINANCES_DOCS"},alerts:{id:"alerts",title:"Оповещения",icon:n.jsx(ao,{}),path:wn,Component:Tf,color:"blue",isTemplate:!1,group:"COMMUNICATION"},home:{id:"home",title:"Главная",icon:n.jsx($i,{}),path:bn,Component:Ef,color:"blue",isTemplate:!1,group:"GENERAL",withoutHeader:!0},profile:{id:"profile",title:"Профиль",icon:n.jsx(ro,{}),path:xr,Component:Of,color:"purple",isTemplate:!1,group:"GENERAL",withoutHeader:!0},chat:{id:"chat",title:"Сообщения",icon:n.jsx(oo,{}),path:nn,Component:()=>ce({oldVersionUrl:nn}),color:"red",isTemplate:!0,group:"OTHER"},schedule:{id:"schedule",title:"Расписание",icon:n.jsx(lo,{}),path:It,Component:Pf,color:"pink",isTemplate:!1,group:"LEARNING_ACTIVITIES"},"all-students":{id:"all-students",title:"Студенты",icon:n.jsx(sn,{}),path:mr,Component:ur,color:"lightBlue",isTemplate:!1,group:"COMMUNICATION"},"all-teachers":{id:"all-teachers",title:"Сотрудники",icon:n.jsx(Ei,{}),path:br,Component:yf,color:"orange",isTemplate:!1,group:"COMMUNICATION"},feedback:{id:"feedback",title:"Обратная связь",icon:n.jsx(ot,{}),path:vn,Component:hr,color:"blue",isTemplate:!1,group:"COMMUNICATION"},instructions:{id:"instructions",title:"Полезная информация",icon:n.jsx(co,{}),path:Xf,Component:kf,color:"blue",isTemplate:!1,group:"GENERAL",show:!1},"medical-certificate":{id:"medical-certificate",title:"Предоставление медицинских справок",icon:n.jsx(po,{}),path:Bf,Component:Ff,color:"blue",isTemplate:!1,group:"GENERAL"}},Er={"teachers-schedule":{id:"teachers-schedule",title:"Расписание преподавателя",icon:n.jsx(I,{}),path:Zf,Component:Nf,color:"blue",isTemplate:!1,show:!1,group:"OTHER"},"filtered-all-students":{id:"filtered-all-students",title:"Все студенты",icon:n.jsx(sn,{}),path:Vf,Component:ur,color:"blue",isTemplate:!1,show:!1,group:"OTHER"},"settings-appearance":{id:"settings-appearance",title:"Настройки. Внешний вид",icon:n.jsx(uo,{}),path:Gf,Component:Cf,color:"purple",isTemplate:!0,show:!0,group:"OTHER"},"settings-personal":{id:"settings-personal",title:"Настройки. Аккаунт",icon:n.jsx(ho,{}),path:qf,Component:Af,color:"pink",isTemplate:!0,show:!0,group:"OTHER"},"settings-security":{id:"settings-security",title:"Настройки. Безопасность",icon:n.jsx(go,{}),path:Yf,Component:If,color:"green",isTemplate:!0,show:!0,group:"OTHER"},"settings-home-page":{id:"settings-home-page",title:"Настройки. Домашний экран",icon:n.jsx($i,{}),path:Kf,Component:Rf,color:"blue",isTemplate:!0,show:!0,group:"OTHER"},"settings-customize-menu":{id:"settings-customize-menu",title:"Настройки. Меню",icon:n.jsx(fo,{}),path:Jf,Component:()=>n.jsx(n.Fragment,{}),color:"red",isTemplate:!0,show:!0},"useful-info-template":{id:"useful-info-template",title:"Полезная информация",icon:"",path:Qf,Component:fn,color:"grey",isTemplate:!0,show:!0}},nx=()=>{const{allRoutes:e}=we.useMenu();return e?n.jsxs(Ai,{children:[Object.values(e).map(({path:t,Component:i,isTemplate:s})=>n.jsx(Ci,{path:t,component:i,exact:!s},t)),n.jsx(Ri,{exact:!0,to:bn})]}):null},ix=G.memo(nx),sx=()=>{const{data:{user:e}}=Q.useUser(),[t,i]=c.useState(!1),s=a=>{const r=localStorage.getItem("lastLocalAccess")||a,o=new Date(To);new Date(a)<o&&new Date(r)<o&&(localStorage.setItem("lastLocalAccess",new Date().toISOString()),i(!0))};return c.useEffect(()=>{e&&s(e.lastaccess)},[e]),t},ax=()=>{var o,l;const e=dt(),{data:t}=Q.useUser(),i=(o=t.user)!=null&&o.subdivisions?{...Zt(),...Qt()}:{...Ne(),...Xt()},[{exactCurrentPage:s,currentPage:a},r]=c.useState({currentPage:Object.values(i).find(d=>e.location.pathname.includes(d.path))??i[0],exactCurrentPage:Object.values(i).find(d=>e.location.pathname.includes(d.path))??null});return c.useEffect(()=>{r({currentPage:Object.values(i).find(d=>e.location.pathname.includes(d.path))??i[0],exactCurrentPage:Object.values(i).find(d=>d.path.includes(e.location.pathname))??null})},[(l=t.user)==null?void 0:l.subdivisions]),c.useEffect(()=>e.listen(d=>{r({currentPage:Object.values(i).find(p=>d.pathname.includes(p.path))??i[0],exactCurrentPage:Object.values(i).find(p=>p.path.includes(d.pathname))??null})}),[e,i]),{currentPage:a,exactCurrentPage:s}},rx=x.div`
    height: fit-content;
...
`,ox=()=>{const{open:e,content:t,position:i}=th.useContextMenu(),s=c.useRef(null);return We(s,()=>ie.close()),n.jsx(Rt,{isOpen:e,children:n.jsx(rx,{isVisible:e,ref:s,left:i.x,top:i.y,onClick:a=>{a.stopPropagation()},children:t})})},lx=["loading"],mi=x.div.withConfig({shouldForwardProp:e=>!lx.includes(e)})`
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
`,cx=({loading:e})=>{const{error:t}=Q.useUser();return t?n.jsx(mi,{loading:!0,children:n.jsx(oe,{text:"Нет подключения к интернету",children:n.jsx(j,{onClick:()=>Pc.getUserFx(JSON.parse(localStorage.getItem("token")??"")),text:"Попробовать снова",icon:n.jsx(wi,{})})})}):n.jsxs(mi,{loading:e,children:[n.jsx(At,{short:!0,width:"100px"}),e&&n.jsx($e,{})]})},dx=x.div`
    width: 100%;
    height: 5px;
    background: var(--almostTransparentOpposite);
    border-radius: 10px;
...
`,xx=({background:e,align:t,image:i,color:s,title:a,text:r,children:o,setPlaying:l,link:d,imageAlign:p,imageSize:u={width:"auto",height:"100%"},textAlign:m="left"})=>{const b=dt();return n.jsxs(fx,{imageAlign:p,onClick:()=>l(h=>!h),background:e,align:t,padding:"0",height:"100%",color:s,children:[i&&n.jsx(Ts,{src:i,loading:!1,width:u.width,height:u.height}),n.jsxs("div",{className:"text-content",children:[n.jsx(U,{size:2,align:m,children:a}),n.jsx(Ve,{fontSize:"1.1em",align:m,children:r}),!!(d!=null&&d.text)&&n.jsx(j,{onClick:()=>{b.push(d.to),Te.close()},text:d.text}),o&&n.jsx("div",{className:"content-children",children:o})]})]})},mx=x.div`
    padding: 15px;
    width: 100%;
    max-width: 400px;
    height: 100%;
...
`,bx=()=>{const{pages:e,isOpen:t,currentPage:i}=mn.useStory(),s=c.useRef(null);We(s,()=>Te.close());const[a,r]=c.useState(!0),o=e[i];return n.jsx(Rt,{isOpen:t,children:n.jsx(mx,{isOpen:t,ref:s,children:e.length!==0&&n.jsxs(n.Fragment,{children:[n.jsx(hx,{pages:e.length,onClose:()=>Te.close(),playing:a}),n.jsx(bi,{left:"15px",onClick:()=>{i!==0&&Te.changeCurrentPage({value:i-1}),r(!0)},children:n.jsx(ut,{})}),n.jsx(xx,{setPlaying:r,currentPage:i,...o}),n.jsx(bi,{right:"15px",onClick:()=>{i!==e.length-1?Te.changeCurrentPage({value:i+1}):Te.close(),r(!0)},children:n.jsx(kt,{})})]})})})},vx=x.div`
    display: flex;
    background: var(--theme);
    height: 100vh;
`,yx=x.div`
...
`,_x=()=>{var o;const{data:{user:e}}=Q.useUser(),{open:t}=J(),i=sx(),{currentPage:s,exactCurrentPage:a}=ax(),{height:r}=Ge();return c.useEffect(()=>{e&&Ao.getLocalSettingsFx(e.id)},[e]),gt(),c.useEffect(()=>{z.evokePopUpMessage({message:n.jsxs(n.Fragment,{children:["Если вы хотите перейти ",n.jsx("br",{})," в старый личный кабинет,"," ",n.jsx("a",{href:`${de}/index.php`,children:"нажмите сюда"})]}),type:"info",time:5e3}),e!=null&&e.hasAlerts&&setTimeout(()=>z.evokePopUpMessage({message:n.jsx(Y,{to:wn,children:"У вас есть новые оповещения"}),type:"tip",time:5e3}),5e3)},[e]),c.useEffect(()=>{i&&i&&t(n.jsx(xn,{}))},[i]),n.jsxs(vx,{style:{height:r},children:[n.jsx(cx,{loading:!e}),n.jsx(bx,{}),n.jsx(Dh,{}),n.jsxs(yx,{children:[n.jsx(hh,{currentPagePair:{currentPage:s,exactCurrentPage:a}}),n.jsx(wx,{withHeader:!((o=a??s)!=null&&o.withoutHeader),children:n.jsx(c.Suspense,{fallback:null,children:n.jsx(ix,{})})}),n.jsx(vg,{})]}),n.jsx(Wh,{}),n.jsx(Mh,{}),n.jsx(Gh,{}),n.jsx(ox,{}),n.jsx(kg,{})]})},jx=()=>{const{data:{isAuthenticated:e,user:t}}=Q.useUser(),{data:i}=Ht.selectors.useData(),{settings:s}=on.useSettings(),[a,r]=c.useState(e);return c.useEffect(()=>(e?(setTimeout(()=>{r(!0)},1e3),Ht.effects.getFx(),Se.getUserDataApplicationsFx(),Se.getWorkerPosts()):r(!1),()=>{r(!1)}),[e]),c.useEffect(()=>{t&&s&&xt.defineMenu({user:t,adminLinks:i,homeRoutes:s["settings-home-page"].property.pages})},[t,i,s]),e&&a?n.jsx(_x,{}):n.jsx(c.Suspense,{fallback:null,children:n.jsxs(Ai,{children:[tx.map(({path:o,Component:l},d)=>n.jsx(Ci,{path:o,component:l,exact:!0},d)),n.jsx(Ri,{exact:!0,to:gr})]})})},Tx=x.div`
    background: var(--theme);
    overflow-y: auto;
    height: 100vh;
...
`;yo.render(n.jsxs(G.StrictMode,{children:[n.jsx(kx,{}),n.jsx(Ex,{})]}),document.getElementById("root"));export{R as $,_p as A,$t as B,ve as C,$d as D,oe as E,hn as F,ph as G,ks as H,dp as I,we as J,De as K,un as L,K as M,Qf as N,qx as O,ce as P,He as Q,wp as R,Es as S,U as T,jr as U,vp as V,pn as W,Yn as X,Ux as Y,Bl as Z,Ul as _,z as a,St as a$,he as a0,te as a1,bd as a2,jd as a3,Vx as a4,Wx as a5,de as a6,Ro as a7,Ot as a8,Mx as a9,wn as aA,dc as aB,Yl as aC,kn as aD,gh as aE,tc as aF,It as aG,Ox as aH,Yx as aI,mr as aJ,cc as aK,ad as aL,zx as aM,Ts as aN,Lx as aO,ye as aP,gt as aQ,ag as aR,Xa as aS,ng as aT,ge as aU,qf as aV,pe as aW,Et as aX,ft as aY,Xx as aZ,Ii as a_,Mo as aa,ex as ab,fr as ac,xt as ad,Th as ae,on as af,en as ag,Ah as ah,j as ai,Eh as aj,kh as ak,td as al,Jx as am,nn as an,qe as ao,ie as ap,Ge as aq,J as ar,We as as,$l as at,Al as au,Ko as av,Is as aw,Wf as ax,ql as ay,lc as az,wc as b,Oh as b0,Sh as b1,Nx as b2,Ix as b3,ht as b4,Qd as b5,og as b6,$s as b7,Cx as b8,la as b9,Rx as ba,As as bb,rc as bc,Pc as bd,bt as be,Dx as bf,gc as bg,fc as bh,hl as bi,Ax as bj,gl as bk,Px as bl,$x as bm,ud as bn,Fx as bo,vt as bp,xp as bq,mp as br,fp as bs,gp as bt,ec as bu,kl as c,Ht as d,_c as e,_ as f,ue as g,Hx as h,Bx as i,Gx as j,Cs as k,Ct as l,L as m,_l as n,$e as o,bp as p,Ie as q,Kx as r,yc as s,cn as t,Ve as u,se as v,nf as w,Q as x,gn as y,Oe as z};
