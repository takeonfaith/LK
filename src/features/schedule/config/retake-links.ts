        ...
        links: [
            {
                ...
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2021-2022-leto__kafedra_IB__bakalavry_i_spetsialisty.pdf',
            },
            {
                title: 'ФИТ 2021-2022-лето, кафедра ПИ',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2021-2022-leto__kafedra_PI.pdf',
            },
            {
                title: 'ФИТ 2021-2022-лето, кафедра СМАРТ, профиль САПР',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2021-2022-leto__kafedra_SMART__profil_SAPR.pdf',
            },
            {
                title: 'ФИТ 2021-2022-лето, кафедра СМАРТ, магистры',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2021-2022-leto__kafedra_SMART__magistry.pdf',
            },
            {
                title: 'ФИТ 2021-2022-лето, кафедра СМАРТ, профиль КФС',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2021-2022-leto__kafedra_SMART__profil_KFS.pdf',
            },
            {
                title: 'ФИТ 2021-2022-лето, кафедра ИКТ, бакалавры и магистры',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2021-2022-leto__kafedra_IKT__bakalavry_i_magistry.pdf',
            },
            {
                title: 'ФИТ 2021-2022-лето, кафедра ИиИТ',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2021-2022-leto__kafedra_IiIT.pdf',
            },
            {
                title: 'ФИТ 2021-2022-лето, кафедра ИиИТ, ВНЕШНИЕ',
                href: 'https://e.mospolytech.ru/old/storage/files/arrears/FIT_2021_2022_leto__kafedra_IiIT__VNEShNIE.pdf',
            },
        ],
        href: '',
    },
