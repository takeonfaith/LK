                    ...
                    events={[
                        {
                            ...
                            startTime: '9:00',
                            color: TimeIntervalColor['9:00 - 10:30' as keyof ITimeIntervalColor].dark1,
                        },
                        {
                            title: 'Высшая математика',
                            icon: getSubjectIcon('Высшая математика'),
                            duration: 90,
                            place: 'Прянишникова 2А, 2445',
                            placeIcon: <HiOutlineOfficeBuilding />,
                            people: ['Test Test Test'],
                            startTime: '10:40',
                            color: TimeIntervalColor['10:40 - 12:10' as keyof ITimeIntervalColor].dark1,
                        },
                        {
                        ...
                        },
                        {
                            ...
                            people: ['Test Test Test'],
                            startTime: '14:30',
                            color: TimeIntervalColor['14:30 - 16:00' as keyof ITimeIntervalColor].dark1,
                        },
                    ]}
                />
            </PageBlock>
